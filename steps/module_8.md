...
curl -X POST -F 'username=Admin' -F 'password=password' http://localhost:8000/api-token-auth/

http post http://localhost:8000/api-token-auth/ username=Admin password=password


> This will retrieve all items

curl -X GET -H 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a' http://localhost:8000/item/

http http://localhost:8000/item/ 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a'


> This will retreive a single item

curl -X GET -H 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a' http://localhost:8000/item/282725f2-d94f-4abe-9abc-c6406109db2e/

http http://localhost:8000/item/282725f2-d94f-4abe-9abc-c6406109db2e/ 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a' http://localhost:8000/order/

http http://localhost:8000/order/ 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a'

> This will place an order for item id = 282725f2-d94f-4abe-9abc-c6406109db2e quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a' -d '{"item": "282725f2-d94f-4abe-9abc-c6406109db2e", "quantity": "1"}' http://localhost:8000/order/

http http://localhost:8000/order/ 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a' item="282725f2-d94f-4abe-9abc-c6406109db2e" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a' http://localhost:8000/order/**your_order_uuid**/

http http://localhost:8000/order/**your_order_uuid**/ 'Authorization: Token 1584de73ce017aa18d22421637b1e49f34c5464a'
